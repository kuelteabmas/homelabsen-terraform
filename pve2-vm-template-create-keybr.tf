...
# resource "proxmox_vm_qemu" "pve2-vm-template-create-keybr" {
    
#     # VM General Settings
#     target_node = "pve2"
#     vmid = "302"
#     name = "keybr"
#     desc = "keybr.com instance VM"
...
#     ipconfig0 = "ip=192.168.12.31/24,gw=192.168.12.1"
#     nameserver = "1.1.1.1"
...
#     sshkeys = file("~/.ssh/pve2_keybr.pub")
# }